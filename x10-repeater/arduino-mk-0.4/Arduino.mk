...
SYS_C_SRCS     = $(wildcard $(ARDUINO_LIB_PATH)/*.c)
SYS_CPP_SRCS   = $(wildcard $(ARDUINO_LIB_PATH)/*.cpp)
...
#
ifndef AVRDUDE
AVRDUDE          = $(ARDUINO_ETC_PATH)/avrdude
endif

AVRDUDE_COM_OPTS = -v -V -p $(MCU)
ifdef AVRDUDE_CONF
...
#AVRDUDE_ARD_OPTS = -c $(AVRDUDE_ARD_PROGRAMMER) -P $(ARD_PORT)
...
clean:
		$(REMOVE) $(OBJS) $(TARGETS) $(DEP_FILE) $(DEPS) $(SYS_OBJS)
